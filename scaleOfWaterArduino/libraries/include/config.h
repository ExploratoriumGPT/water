...
const int handDropSteps = 2754;   // round((float)handDropVolumeUl / uLsPerRev * stepsPerRev);
...
// Timeout
const int timeoutMillis = 30000; // Timeout duration in milliseconds, 20 seconds
// Other timing variables
const int tankDrainDuration = 10000;        // Duration to drain the big tank
const int tankFillDuration = 5600;          // 5500=14;  // Duration to fill the big tank
const int minimumLittleDropInterval = 7000; // Minimum interval between little drops
const int delayBetweenDispenses = 3750;     // Duration of little drop
